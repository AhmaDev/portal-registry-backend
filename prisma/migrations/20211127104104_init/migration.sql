...
CREATE TABLE `AdministrativeOrder` (
    ...
    `orderNumber` VARCHAR(220) NOT NULL,
...
CREATE TABLE `Student` (
    ...
    `englishName` VARCHAR(220) NOT NULL DEFAULT 'englishName',
    `mail` VARCHAR(220) NOT NULL DEFAULT 'student@duc.edu.iq',
    ...
    UNIQUE INDEX `Student_collegeNumber_key`(`collegeNumber`),
...
CREATE TABLE `NationalInfo` (
    ...
    UNIQUE INDEX `NationalInfo_studentId_key`(`studentId`),
...
CREATE TABLE `StudentGraduation` (
    ...
    UNIQUE INDEX `StudentGraduation_studentId_key`(`studentId`),
...
CREATE TABLE `StudentSchool` (
    ...
    `examNumber` VARCHAR(220) NOT NULL,
    `graduationDate` INTEGER NOT NULL DEFAULT 1,
    `documentDate` VARCHAR(220) NOT NULL DEFAULT '1960-01-01',
    `totalMarks` INTEGER NOT NULL,
    `average` DOUBLE NOT NULL,
    `documentNumber` INTEGER NOT NULL DEFAULT 1,
    `documentDigit` INTEGER NOT NULL DEFAULT 1,
    ...
    UNIQUE INDEX `StudentSchool_studentId_key`(`studentId`),
